...
Esta versão encerra o projeto informacional e deixa o projeto conceitual em aberto. O conteúdo segue as mesmas etapas do relatório-base: pré-desenvolvimento, projeto informacional, projeto conceitual e consideração final. As afirmações provenientes da observação e dos relatos permanecem qualitativas. As especificações cuja partida ainda é estimada estão indicadas como provisórias até a medição prevista no plano de coleta.
